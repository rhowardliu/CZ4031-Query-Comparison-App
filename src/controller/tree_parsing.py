        ...
        if a_set == b_set:
            if len(a_set) == 1:
                ...
                if a.children[0] == b.children[0]:
                    cluster_1 = get_cluster_set(
                        a.children[0], b.children[0], set())
                    cluster_2 = get_cluster_set(
                        a.children[1], b.children[1], set())
                else:
                    cluster_1 = get_cluster_set(
                        a.children[0], b.children[1], set())
                    cluster_2 = get_cluster_set(
                        a.children[1], b.children[0], set())
